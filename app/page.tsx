  ...
  return (
    <main style={{ fontFamily: "'Georgia', serif", background: '#080604', color: '#FDF6EE', overflowX: 'hidden' }}>
      ...
      <section style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', backgroundImage: "url('/hero-bg.jpg')", backgroundSize: 'cover', backgroundPosition: 'center 30%', backgroundRepeat: 'no-repeat', padding: '120px 24px 80px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <p style={{ fontSize: 'clamp(16px, 1.6vw, 20px)', color: 'rgba(253,246,238,0.72)', margin: '0 0 48px', lineHeight: 1.8, maxWidth: '540px', position: 'relative', zIndex: 2, fontFamily: 'system-ui, sans-serif' }}>
        ...
        <div style={{ position: 'relative', zIndex: 2, display: 'flex', gap: '48px', flexWrap: 'wrap', justifyContent: 'center', marginBottom: '36px' }}>
          {[["1,811", "Women registered"], ["1,199", "Men registered"], ["Free", "To join and browse"]].map(([n, l]) => (
            <div key={n} style={{ textAlign: "center" }}>
              ...
              <div style={{ fontSize: "11px", color: "rgba(253,246,238,0.45)", letterSpacing: "1.5px", marginTop: "4px", fontFamily: "system-ui, sans-serif" }}>{l}</div>
            </div>
          ))}
        </div>
        <div style={{ position: 'relative', zIndex: 2, display: 'flex', gap: '10px', flexWrap: 'wrap', justifyContent: 'center' }}>
          {["Searching for yourself", "Searching for your child", "Searching for a sibling", "Living abroad"].map(label => (
            <span key={label} style={{ fontSize: "12px", color: "rgba(253,246,238,0.5)", border: "1px solid rgba(240,192,64,0.2)", borderRadius: "20px", padding: "5px 14px", fontFamily: "system-ui, sans-serif" }}>{label}</span>
          ))}
        </div>
      ...
      <section style={{ padding: 'clamp(60px,8vw,100px) clamp(24px,6vw,80px)', borderTop: '1px solid rgba(240,192,64,0.08)' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '64px', alignItems: 'center' }}>
          <div>
            <p style={{ fontSize: '11px', color: 'rgba(240,192,64,0.5)', letterSpacing: '3px', marginBottom: '16px', fontFamily: 'system-ui, sans-serif' }}>THE FEATURE NOBODY ELSE HAS</p>
            ...
            <p style={{ fontSize: 'clamp(15px, 1.4vw, 17px)', color: 'rgba(253,246,238,0.65)', lineHeight: 1.9, margin: '0 0 28px', fontFamily: 'system-ui, sans-serif' }}>
            ...
            <p style={{ fontSize: '14px', color: 'rgba(253,246,238,0.38)', fontStyle: 'italic', fontFamily: 'system-ui, sans-serif' }}>No other matrimony platform in Bangladesh does this.</p>
          </div>
          <div style={{ background: 'linear-gradient(135deg, rgba(240,192,64,0.06), rgba(240,192,64,0.02))', border: '1px solid rgba(240,192,64,0.18)', borderRadius: '20px', padding: '28px', fontFamily: 'system-ui, sans-serif' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', paddingBottom: '16px', borderBottom: '1px solid rgba(240,192,64,0.1)' }}>
              <div>
                <div style={{ fontSize: '12px', color: 'rgba(253,246,238,0.4)', letterSpacing: '1px', marginBottom: '4px' }}>WHY YOU MATCH</div>
                <div style={{ fontSize: '13px', color: 'rgba(253,246,238,0.6)' }}>Sumaiya, 26 · Dhaka</div>
              </div>
            ...
            {[
              ...
              <div key={label} style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '9px 11px', borderRadius: '10px', marginBottom: '6px', background: match ? 'rgba(16,185,129,0.07)' : 'rgba(249,115,22,0.07)', border: "1px solid " + (match ? 'rgba(16,185,129,0.18)' : 'rgba(249,115,22,0.18)') }}>
                ...
                <span style={{ fontSize: '12px', color: 'rgba(253,246,238,0.75)', width: '64px', fontWeight: 600 }}>{label}</span>
                <span style={{ fontSize: '10px', color: 'rgba(253,246,238,0.35)', flex: 1 }}>You: {you} · Profile: {them}</span>
                <span style={{ fontSize: '13px' }}>{match ? "✅" : "❌"}</span>
                <span style={{ fontSize: '10px', color: 'rgba(253,246,238,0.3)', width: '32px', textAlign: 'right' }}>{pts}</span>
              </div>
            ))}
            <div style={{ marginTop: '14px', textAlign: 'center' }}>
              <span style={{ fontSize: '11px', color: 'rgba(253,246,238,0.3)' }}>Based on 13 compatibility factors</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: 'clamp(60px,8vw,100px) clamp(24px,6vw,80px)', borderTop: '1px solid rgba(240,192,64,0.08)' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <p style={{ fontSize: '11px', color: 'rgba(240,192,64,0.5)', letterSpacing: '3px', marginBottom: '16px', textAlign: 'center', fontFamily: 'system-ui, sans-serif' }}>BIYEKORI IS FOR</p>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '20px' }}>
            {[
              ...
              <div key={title} style={{ background: 'rgba(240,192,64,0.04)', border: '1px solid rgba(240,192,64,0.1)', borderRadius: '16px', padding: '28px 24px' }}>
                ...
                <p style={{ fontSize: '14px', color: 'rgba(253,246,238,0.62)', lineHeight: 1.75, margin: 0, fontFamily: 'system-ui, sans-serif' }}>{desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ padding: 'clamp(60px,8vw,100px) clamp(24px,6vw,80px)', borderTop: '1px solid rgba(240,192,64,0.08)' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <p style={{ fontSize: '11px', color: 'rgba(240,192,64,0.5)', letterSpacing: '3px', marginBottom: '16px', textAlign: 'center', fontFamily: 'system-ui, sans-serif' }}>WHAT MAKES BIYEKORI DIFFERENT</p>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '20px' }}>
            {[
              ...
              <div key={title} style={{ padding: '28px 24px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(240,192,64,0.08)', borderRadius: '16px' }}>
                ...
                <p style={{ fontSize: '13px', color: 'rgba(253,246,238,0.58)', lineHeight: 1.85, margin: 0, fontFamily: 'system-ui, sans-serif' }}>{desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ padding: 'clamp(60px,8vw,100px) clamp(24px,6vw,80px)', borderTop: '1px solid rgba(240,192,64,0.08)', textAlign: 'center' }}>
        <div style={{ maxWidth: '780px', margin: '0 auto' }}>
          <p style={{ fontSize: '11px', color: 'rgba(240,192,64,0.5)', letterSpacing: '3px', marginBottom: '16px', fontFamily: 'system-ui, sans-serif' }}>SAFETY AND TRUST</p>
          ...
          <p style={{ fontSize: 'clamp(15px, 1.4vw, 17px)', color: 'rgba(253,246,238,0.62)', lineHeight: 1.9, margin: '0 0 52px', fontFamily: 'system-ui, sans-serif' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: '16px' }}>
            {[
              ...
              <div key={title as string} style={{ padding: '22px 14px', background: 'rgba(240,192,64,0.04)', border: '1px solid rgba(240,192,64,0.1)', borderRadius: '12px' }}>
                ...
                <div style={{ fontSize: '11px', color: 'rgba(253,246,238,0.38)', fontFamily: 'system-ui, sans-serif' }}>{sub as string}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section style={{ padding: 'clamp(60px,8vw,100px) clamp(24px,6vw,80px)', borderTop: '1px solid rgba(240,192,64,0.08)' }}>
        <div style={{ maxWidth: '680px', margin: '0 auto', textAlign: 'center' }}>
          <p style={{ fontSize: 'clamp(18px, 2vw, 26px)', color: 'rgba(253,246,238,0.72)', lineHeight: 2.0, fontStyle: 'italic', margin: '0 0 28px' }}>
          ...
          <p style={{ fontSize: '12px', color: 'rgba(253,246,238,0.3)', letterSpacing: '2px', fontFamily: 'system-ui, sans-serif' }}>THE BIYEKORI TEAM · DHAKA, BANGLADESH</p>
        </div>
      </section>
      ...
      <section style={{ minHeight: '55vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', borderTop: '1px solid rgba(240,192,64,0.08)', textAlign: 'center', padding: 'clamp(60px,8vw,100px) 24px', position: 'relative' }}>
        ...
        <p style={{ fontSize: 'clamp(15px, 1.4vw, 18px)', color: 'rgba(253,246,238,0.5)', margin: '0 0 48px', position: 'relative', zIndex: 2, fontFamily: 'system-ui, sans-serif' }}>
          Free to join. No credit card. 3,010 real profiles waiting.
        </p>
        <div style={{ position: 'relative', zIndex: 2 }}>
          <HomeCTA2 />
        </div>
        <p style={{ fontSize: '11px', color: 'rgba(253,246,238,0.15)', letterSpacing: '2px', margin: '40px 0 0', position: 'relative', zIndex: 2, fontFamily: 'system-ui, sans-serif' }}>
      ...
      <footer style={{ padding: 'clamp(40px,6vw,64px) clamp(24px,6vw,80px) 40px', borderTop: '1px solid rgba(240,192,64,0.15)' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '40px', marginBottom: '48px' }}>
          <div style={{ maxWidth: '260px' }}>
            ...
            <p style={{ margin: '0 0 8px', fontSize: '13px', color: 'rgba(253,246,238,0.3)', fontStyle: 'italic' }}>
              <span style={{ fontFamily: 'var(--font-hind-siliguri)' }}>আপনার জন্য কেউ অপেক্ষা করছে</span>
            </p>
            <p style={{ margin: 0, fontSize: '14px', color: 'rgba(253,246,238,0.5)', lineHeight: 1.7, fontFamily: 'system-ui, sans-serif' }}>Bangladesh&apos;s most thoughtful matrimony platform. Built in Dhaka.</p>
          </div>
          <div style={{ display: 'flex', gap: '48px', flexWrap: 'wrap' }}>
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                {["Profiles","Pricing","About","FAQ"].map(l => (
                  <Link key={l} href={"/" + l.toLowerCase()} style={{ fontSize: '14px', color: 'rgba(253,246,238,0.6)', textDecoration: 'none', fontFamily: 'system-ui, sans-serif' }}>{l}</Link>
                ))}
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                <a href="mailto:support@biyekori.com" style={{ fontSize: '14px', color: 'rgba(253,246,238,0.6)', textDecoration: 'none', fontFamily: 'system-ui, sans-serif' }}>support@biyekori.com</a>
                <a href="https://wa.me/8801733577215" target="_blank" rel="noreferrer" style={{ fontSize: '14px', color: 'rgba(253,246,238,0.6)', textDecoration: 'none', fontFamily: 'system-ui, sans-serif' }}>WhatsApp</a>
              </div>
            </div>
          </div>
        </div>
        <div style={{ borderTop: '1px solid rgba(240,192,64,0.1)', paddingTop: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
          <span style={{ fontSize: '13px', color: 'rgba(253,246,238,0.35)', fontFamily: 'system-ui, sans-serif' }}>&copy; 2026 Biyekori. All rights reserved.</span>
