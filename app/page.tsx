...
export default function Home() {
  return (
    <main style={{ fontFamily: "'Georgia', serif", background: '#FBF6EE', color: '#1a0a0d', overflowX: 'hidden' }}>
      ...
      <section style={{ position: 'relative', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'flex-start', justifyContent: 'center', backgroundImage: "url('/hero-wedding.jpg')", backgroundSize: 'cover', backgroundPosition: 'center top', backgroundRepeat: 'no-repeat', padding: '120px 24px 80px 50%', textAlign: 'left', overflow: 'hidden' }}>
        ...
        <p style={{ fontSize: 'clamp(16px, 2vw, 22px)', color: '#B89255', margin: '0 0 14px', letterSpacing: '3px', position: 'relative', zIndex: 2, fontStyle: 'italic' }}>
        </p>
        ...
        <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, background: 'rgba(255,255,255,0.97)', padding: '18px 40px', display: 'flex', gap: '0', justifyContent: 'center', zIndex: 2 }}>
          {[['1,811', 'Women registered'], ['1,199', 'Men registered'], ['3,010+', 'Total profiles'], ['Free', 'To join & browse']].map(([n, l], i) => (
            <div key={n} style={{ textAlign: 'center', padding: '0 40px', borderRight: i < 3 ? '1px solid rgba(240,192,64,0.2)' : 'none' }}>
              <div style={{ fontSize: 'clamp(20px, 2.5vw, 28px)', fontWeight: 800, color: '#B89255', letterSpacing: '-1px' }}>{n}</div>
      ...
      {/* DEMO EXPERIENCE */}
      <section style={{ padding: 'clamp(60px,8vw,100px) clamp(24px,6vw,80px)', background: '#FBF6EE', borderTop: '1px solid rgba(123,29,46,0.08)' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '64px', alignItems: 'center' }}>
          <div>
            <p style={{ fontSize: '13px', color: '#6D1F2F', letterSpacing: '3px', marginBottom: '16px', fontFamily: 'system-ui, sans-serif', textTransform: 'uppercase', opacity: 0.7 }}>Try before you join</p>
            <h2 style={{ fontSize: 'clamp(28px, 3.5vw, 48px)', fontWeight: 700, color: '#1a0a0d', margin: '0 0 20px', lineHeight: 1.1 }}>
              Call. Message. Play.<br/><span style={{ color: '#6D1F2F' }}>Feel it first.</span>
            </h2>
      ...
      {/* FINAL CTA */}
      <section style={{ minHeight: '50vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#6D1F2F', textAlign: 'center', padding: 'clamp(60px,8vw,100px) 24px', position: 'relative', overflow: 'hidden' }}>
        ...
        <p style={{ fontSize: 'clamp(18px, 2vw, 24px)', color: '#B89255', margin: '0 0 16px', position: 'relative', zIndex: 2, letterSpacing: '2px' }}>
        </p>
        <h2 style={{ fontSize: 'clamp(32px, 4.5vw, 62px)', fontWeight: 700, color: '#FFFFFF', margin: '0 0 20px', lineHeight: 1.05, position: 'relative', zIndex: 2, letterSpacing: '-1.5px' }}>
          Your person is out there.<br/><span style={{ color: '#B89255' }}>Go find them.</span>
        </h2>
      ...
      {/* FOOTER */}
      <footer style={{ padding: 'clamp(40px,6vw,64px) clamp(24px,6vw,80px) 40px', background: '#4B1421', borderTop: '3px solid #B89255' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '40px', marginBottom: '48px' }}>
          <div style={{ maxWidth: '280px' }}>
            <span style={{ fontSize: '24px', fontWeight: 800, color: '#B89255', letterSpacing: '4px', display: 'block', marginBottom: '10px' }}>BIYEKORI</span>
          ...
          <div style={{ display: 'flex', gap: '48px', flexWrap: 'wrap' }}>
            <div>
              <p style={{ margin: '0 0 16px', fontSize: '11px', fontWeight: 700, color: '#B89255', letterSpacing: '2px', fontFamily: 'system-ui, sans-serif' }}>PLATFORM</p>
            ...
            <div>
              <p style={{ margin: '0 0 16px', fontSize: '11px', fontWeight: 700, color: '#B89255', letterSpacing: '2px', fontFamily: 'system-ui, sans-serif' }}>LEGAL</p>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            ...
            <div>
              <p style={{ margin: '0 0 16px', fontSize: '11px', fontWeight: 700, color: '#B89255', letterSpacing: '2px', fontFamily: 'system-ui, sans-serif' }}>CONTACT</p>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
        ...
        <div style={{ borderTop: '1px solid rgba(240,192,64,0.15)', paddingTop: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
            <a href="https://facebook.com/biyekori" target="_blank" rel="noreferrer" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '42px', height: '42px', borderRadius: '50%', background: 'rgba(240,192,64,0.1)', border: '1px solid rgba(240,192,64,0.2)' }}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="#B89255"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
            </a>
            <a href="https://instagram.com/biyekori" target="_blank" rel="noreferrer" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '42px', height: '42px', borderRadius: '50%', background: 'rgba(240,192,64,0.1)', border: '1px solid rgba(240,192,64,0.2)' }}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#B89255" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
            </a>
            <a href="https://youtube.com/@biyekori" target="_blank" rel="noreferrer" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '42px', height: '42px', borderRadius: '50%', background: 'rgba(240,192,64,0.1)', border: '1px solid rgba(240,192,64,0.2)' }}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="#B89255"><path d="M22.54 6.42a2.78 2.78 0 0 0-1.95-1.96C18.88 4 12 4 12 4s-6.88 0-8.59.46A2.78 2.78 0 0 0 1.46 6.42 29 29 0 0 0 1 12a29 29 0 0 0 .46 5.58 2.78 2.78 0 0 0 1.95 1.96C5.12 20 12 20 12 20s6.88 0 8.59-.46a2.78 2.78 0 0 0 1.95-1.96A29 29 0 0 0 23 12a29 29 0 0 0-.46-5.58z"/><polygon points="9.75 15.02 15.5 12 9.75 8.98 9.75 15.02" fill="#1a0a0d"/></svg>
            </a>
            <a href="https://linkedin.com/company/biyekori" target="_blank" rel="noreferrer" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '42px', height: '42px', borderRadius: '50%', background: 'rgba(240,192,64,0.1)', border: '1px solid rgba(240,192,64,0.2)' }}>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="#B89255"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg>
            </a>
          </div>
        </div>
      </footer>
