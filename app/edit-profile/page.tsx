            ...
            <div style={{ background: 'white', borderRadius: '16px', boxShadow: '0 1px 4px rgba(0,0,0,0.06)', overflow: 'hidden' }}>
              ...
              {showMoreLifestyle && (
                <div style={{ padding: '0 24px 24px' }}>
                  <p style={{ margin: '0 0 16px', fontSize: '12px', color: '#9ca3af' }}>These details help us find more compatible matches. All optional.</p>
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                    <div>
                      <label className={labelClass}>Family Involvement Preference</label>
                      <select value={familyInvolvement} onChange={e => setFamilyInvolvement(e.target.value)} className={inputClass}>
                        <option value="">Select</option>
                    ...
                    <div>
                      ...
                      <select value={socialLifestyle} onChange={e => setSocialLifestyle(e.target.value)} className={inputClass}>
                        <option value="">Select</option>
                    ...
                    <div>
                      ...
                      <select value={weddingStyle} onChange={e => setWeddingStyle(e.target.value)} className={inputClass}>
                        <option value="">Select</option>
